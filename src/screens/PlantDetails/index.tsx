    ...
    <ScrollView style={{ flex: 1 }}>
      <ThemedView style={styles.container}>
        {imageUri ? (
          ...
          <ThemedView
            style={[styles.imagePlaceholder, { backgroundColor: colors.card }]}
          >
        ...
        {mergedPlant?.scientific_name &&
          mergedPlant.scientific_name.length > 0 && (
        ...
        {mergedPlant?.watering_frequency != null &&
          mergedPlant.watering_frequency > 0 && (
            <ThemedView style={styles.section}>
              <ThemedText type="subtitle">Base Watering Frequency</ThemedText>
              <ThemedText>
                Every {mergedPlant.watering_frequency} days
              </ThemedText>
            </ThemedView>
          )}
